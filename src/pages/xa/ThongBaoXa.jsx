...
export default function ThongBaoXa() {
  ...
  const xuLyClickThongBao = async (tb) => {
    ...
    navigate('/xa/nhiem-vu-bao-cao', { state: { baoCaoId: tb.baoCaoId } })
  }
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-5 md:mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs md:text-sm text-slate-500 mt-0.5">Quản lý thông báo từ hệ thống</p>
          </div>
        </div>
      ...
      <div className="space-y-3">
        {danhSachHienThi.length > 0 ? (
          danhSachHienThi.map(tb => {
            const cauHinh = cauHinhLoai[tb.loai] || cauHinhLoai.hoan_thanh
