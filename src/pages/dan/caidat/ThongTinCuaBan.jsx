import { User, Phone, MapPin, Home, Shield, Calendar } from 'lucide-react'
...
export default function ThongTinCuaBan() {
  ...
  const thongTin = [
    ...
    { nhan: 'Địa chỉ', giaTri: `${nguoiDung?.ten_thon || ''}, xã Bà Nà, huyện Hòa Vang, TP. Đà Nẵng`, icon: MapPin },
    { nhan: 'Thôn', giaTri: nguoiDung?.ten_thon || '', icon: Home },
    { nhan: 'Vai trò', giaTri: 'Chủ hộ (Dân)', icon: Shield },
  ]
  return (
