...
export default function FormTaoBaoCao({ hienPopup, dongPopup, themBaoCao }: any) {
  const [form, setForm] = useState<any>(formMacDinh)
  const [loiForm, setLoiForm] = useState<any>({})
