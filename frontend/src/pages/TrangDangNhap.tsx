...
export default function TrangDangNhap() {
  ...
  return (
    <div className="relative h-dvh overflow-y-auto flex flex-col">
      <div className="fixed inset-0 z-0">
        <img src={anhNen} alt="Cầu Vàng Bà Nà" className="absolute inset-0 w-full h-full object-cover object-[70%_center] md:object-center" />
