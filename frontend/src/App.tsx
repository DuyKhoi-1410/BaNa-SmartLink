    ...
    <BrowserRouter>
      ...
      <Suspense fallback={<ManHinhTai />}>
        <Routes>
          ...
          <Route path="/dan" element={<ProtectedRoute vaiTro="dan"><LayoutDan /></ProtectedRoute>}>
          ...
          <Route path="/xa" element={<ProtectedRoute vaiTro="xa"><LayoutXa /></ProtectedRoute>}>
          ...
          <Route path="/thon" element={<ProtectedRoute vaiTro="thon"><LayoutThon /></ProtectedRoute>}>
